...
export class UifWizardService {
	...
	activePageId$ = this.activePageId.asObservable();
	isFinished$ = this.isFinished.asObservable();
	isCancelled$ = this.isCancelled.asObservable();
	nextPageInvoked$ = this.nextPageInvoke.asObservable();
	previousPageInvoked$ = this.previousPageInvoke.asObservable();
	cancelWizardInvoked$ = this.cancelWizardInvoke.asObservable();
	activePageIndex$ = this.activePageIndexSubject.asObservable();
	constructor(
